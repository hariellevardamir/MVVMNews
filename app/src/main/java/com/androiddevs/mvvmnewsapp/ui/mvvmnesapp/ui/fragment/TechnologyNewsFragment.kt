...
import com.androiddevs.mvvmnewsapp.databinding.FragmentTechnologyNewsBinding
...
class TechnologyNewsFragment : Fragment(R.layout.fragment_technology_news) {
    ...
    private val TAG = "TechnologyNewsFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_technologyNewsFragment2_to_articleFragment,
                bundle
            )
        }

        var job: Job? = null
        val text = binding.tvTechnologyLabel.text
        job?.cancel()
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                viewModel.searchNews(binding.tvTechnologyLabel.text.toString())
                isScrolling = false
            } else {
                binding.rvTechnologyNews.setPadding(0, 0, 0, 0)
            }
        }
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvTechnologyNews.apply {
            adapter = newsAdapter
    ...
    private fun onBackPressed() {
        binding.ivTechnologyBackArrow.setOnClickListener {
