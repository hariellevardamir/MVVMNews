...
import com.androiddevs.mvvmnewsapp.databinding.FragmentSportsNewsBinding
...
class SportsNewsFragment : Fragment(R.layout.fragment_sports_news) {
    ...
    private val TAG = "SportsNewsFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_sportsNewsFragment_to_articleFragment,
                bundle
            )
        }

        var job: Job? = null
        val text = binding.tvSportsLabel.text
        job?.cancel()
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                viewModel.searchNews(binding.tvSportsLabel.text.toString())
                isScrolling = false
            } else {
                binding.rvSportsNews.setPadding(0, 0, 0, 0)
            }
        }
    }
    ...
    private fun onBackPressed() {
        binding.ivSportBackArrow.setOnClickListener {
